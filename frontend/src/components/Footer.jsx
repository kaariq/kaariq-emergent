...
export default function Footer() {
  ...
  return (
    <footer className="bg-[hsl(160,30%,12%)] text-[hsl(36,33%,96%)] mt-24">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-3 mt-8">
              <a href="#" aria-label="Instagram" className="w-9 h-9 border border-white/30 hover:bg-white hover:text-[hsl(160,30%,12%)] flex items-center justify-center transition-colors"><Instagram className="w-4 h-4"/></a>
              <a href="#" aria-label="Facebook" className="w-9 h-9 border border-white/30 hover:bg-white hover:text-[hsl(160,30%,12%)] flex items-center justify-center transition-colors"><Facebook className="w-4 h-4"/></a>
              <a href="#" aria-label="Youtube" className="w-9 h-9 border border-white/30 hover:bg-white hover:text-[hsl(160,30%,12%)] flex items-center justify-center transition-colors"><Youtube className="w-4 h-4"/></a>
            </div>
          </div>
